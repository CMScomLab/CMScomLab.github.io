...
2026-03-28追記: こうした運用を実際に始めるための参考として、Git 管理サンプルの [saenm-notebook-template](https://github.com/CMScomLab/saenm-notebook-template) も用意しました。
Notebook や実験結果を整理しながら残していくための最小構成のテンプレートで、記録の始め方や置き方を確認したい場合に使えます。
...
参考リンクの一覧と合わせて見ると、SAENM が単なる抽象的な考え方ではなく、実際にどのような試行の積み重ねから見えてきたものなのかをイメージしやすくなります。

実際の記録例としては、[lsh-cascade-poc の notebooks/README.md](https://github.com/cmscom/lsh-cascade-poc/blob/main/notebooks/README.md) があります。

下の図は、関連する実験ノートや試作が連なっている様子の一例です。個々のノートはそれぞれ小さな試行ですが、並べて眺めることで、関心の移動や判断の変化、次の実験へのつながりを追いやすくなります。

![SAENMにつながる実験ノートの一覧](../../assets/images/2026-03-24-saenm-model-intro-list.png)
